...
public class PacketHandler {
    public static void init() {
        PayloadTypeRegistry.serverboundPlay().register(MessageFallDistance.TYPE, MessageFallDistance.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(MessageWallJump.TYPE, MessageWallJump.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(MessageServerConfig.TYPE, MessageServerConfig.CODEC);
