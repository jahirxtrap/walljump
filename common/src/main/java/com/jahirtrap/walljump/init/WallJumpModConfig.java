...
public class WallJumpModConfig {
    public static final WallJumpModConfig.Common COMMON;
    ...
    public static class Common {
        ...
        Common(ForgeConfigSpec.Builder builder) {
            ...
            this.minFallDistance = builder
                    ...
                    .defineInRange("minFallDistance", 3.0, 3.0, 256);
    ...
    static {
        final Pair<Common, ForgeConfigSpec> specPair = new ForgeConfigSpec.Builder().configure(WallJumpModConfig.Common::new);
