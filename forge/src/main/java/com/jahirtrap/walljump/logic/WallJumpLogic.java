...
public class WallJumpLogic {
    ...
    private static String getBlockId(LocalPlayer pl, BlockPos pos) {
        ...
        return (state.getMaterial().isSolid()) ? BuiltInRegistries.BLOCK.getKey(state.getBlock()).toString() : null;
    }
    ...
    private static void playHitSound(Entity entity, BlockPos blockPos) {
        ...
        SoundType soundtype = state.getBlock().getSoundType(state, entity.getLevel(), blockPos, entity);
    ...
    private static void spawnWallParticle(Entity entity, BlockPos blockPos) {
        ...
        if (state.getRenderShape() != RenderShape.INVISIBLE) {
            ...
            entity.getLevel().addParticle(new BlockParticleOption(ParticleTypes.BLOCK, state).setPos(blockPos), pos.x, pos.y, pos.z,
